...
TEST_CASE("проверка расчета даты Собор 3-x свят. Василия Великого, Григория Богослова и Иоанна Златоустого"){
  constexpr std::array arr = {
    MD(1,30),
    MD(1,30),
    MD(1,30),
...
TEST_CASE("проверка расчета даты Первое и второе Обре́тение главы Иоанна Предтечи"){
  constexpr std::array arr = {
    MD(2,24),
    MD(2,24),
    MD(2,28),
...
TEST_CASE("проверка расчета даты Третье обре́тение главы Иоанна Крестителя"){
  constexpr std::array arr = {
    MD(5,23),
    MD(5,25),
    MD(5,25),
...
TEST_CASE("проверка расчета даты Святых 40 мучеников, в Севастийском е́зере мучившихся"){
  constexpr std::array arr = {
    MD(3,9),
    MD(3,9),
    MD(3,9),
...
TEST_CASE("проверка расчета даты Предпразднство Благовещения Пресвятой Богородицы."){
  constexpr std::array arr = {
    MD(3,24),
    MD(0,0),
    MD(3,23),
...
TEST_CASE("проверка расчета даты Отдание праздника Благовещения Пресвятой Богородицы."){
  constexpr std::array arr = {
    MD(3,26),
    MD(0,0),
    MD(3,26),
...
TEST_CASE("проверка расчета даты Вмч. Гео́ргия Победоно́сца"){
  constexpr std::array arr = {
    MD(4,23),
    MD(4,23),
    MD(4,23),
...
TEST_CASE("проверка расчета даты Память святых отцов шести Вселенских Соборов"){
  constexpr std::array arr = {
    MD(7,14),
    MD(7,13),
    MD(7,19),
...
TEST_CASE("проверка расчета даты Двунадесятые переходящие праздники"){
  constexpr std::array arr = {
    std::array{ MD(3,31), MD(5,16), MD(5,26), },
    std::array{ MD(3,16), MD(5,1), MD(5,11), },
    std::array{ MD(4,5), MD(5,21), MD(5,31), },
    std::array{ MD(3,27), MD(5,12), MD(5,22), },
    std::array{ MD(4,16), MD(6,1), MD(6,11), },
    std::array{ MD(4,1), MD(5,17), MD(5,27), },
    std::array{ MD(3,24), MD(5,9), MD(5,19), },
    std::array{ MD(4,12), MD(5,28), MD(6,7), },
    std::array{ MD(4,4), MD(5,20), MD(5,30), },
    std::array{ MD(3,20), MD(5,5), MD(5,15), },
    std::array{ MD(4,9), MD(5,25), MD(6,4), },
    std::array{ MD(3,31), MD(5,16), MD(5,26), },
    std::array{ MD(3,16), MD(5,1), MD(5,11), },
    std::array{ MD(4,5), MD(5,21), MD(5,31), },
    std::array{ MD(3,28), MD(5,13), MD(5,23), },
    std::array{ MD(4,16), MD(6,1), MD(6,11), },
    std::array{ MD(4,1), MD(5,17), MD(5,27), },
    std::array{ MD(3,24), MD(5,9), MD(5,19), },
    std::array{ MD(4,13), MD(5,29), MD(6,8), },
    std::array{ MD(3,28), MD(5,13), MD(5,23), },
    std::array{ MD(3,20), MD(5,5), MD(5,15), },
    std::array{ MD(4,9), MD(5,25), MD(6,4), },
    std::array{ MD(3,25), MD(5,10), MD(5,20), },
    std::array{ MD(4,13), MD(5,29), MD(6,8), },
    std::array{ MD(4,5), MD(5,21), MD(5,31), },
    std::array{ MD(3,21), MD(5,6), MD(5,16), },
    std::array{ MD(4,10), MD(5,26), MD(6,5), },
    std::array{ MD(4,1), MD(5,17), MD(5,27), },
    std::array{ MD(3,24), MD(5,9), MD(5,19), },
    std::array{ MD(4,6), MD(5,22), MD(6,1), },
    std::array{ MD(3,29), MD(5,14), MD(5,24), },
    std::array{ MD(3,20), MD(5,5), MD(5,15), },
    std::array{ MD(4,9), MD(5,25), MD(6,4), },
    std::array{ MD(3,25), MD(5,10), MD(5,20), },
    std::array{ MD(4,14), MD(5,30), MD(6,9), },
    std::array{ MD(4,5), MD(5,21), MD(5,31), },
    std::array{ MD(3,21), MD(5,6), MD(5,16), },
    std::array{ MD(4,10), MD(5,26), MD(6,5), },
    std::array{ MD(4,2), MD(5,18), MD(5,28), },
    std::array{ MD(3,17), MD(5,2), MD(5,12), },
    std::array{ MD(4,6), MD(5,22), MD(6,1), },
    std::array{ MD(3,29), MD(5,14), MD(5,24), },
    std::array{ MD(4,18), MD(6,3), MD(6,13), },
    std::array{ MD(4,2), MD(5,18), MD(5,28), },
    std::array{ MD(3,25), MD(5,10), MD(5,20), },
    std::array{ MD(4,14), MD(5,30), MD(6,9), },
    std::array{ MD(3,30), MD(5,15), MD(5,25), },
    std::array{ MD(3,21), MD(5,6), MD(5,16), },
    std::array{ MD(4,10), MD(5,26), MD(6,5), },
    std::array{ MD(3,26), MD(5,11), MD(5,21), },
    std::array{ MD(3,18), MD(5,3), MD(5,13), },
    std::array{ MD(4,6), MD(5,22), MD(6,1), },
    std::array{ MD(3,29), MD(5,14), MD(5,24), },
    std::array{ MD(4,11), MD(5,27), MD(6,6), },
    std::array{ MD(4,3), MD(5,19), MD(5,29), },
    std::array{ MD(3,25), MD(5,10), MD(5,20), },
    std::array{ MD(4,7), MD(5,23), MD(6,2), },
    std::array{ MD(3,30), MD(5,15), MD(5,25), },
    std::array{ MD(3,22), MD(5,7), MD(5,17), },
    std::array{ MD(4,10), MD(5,26), MD(6,5), },
    std::array{ MD(3,26), MD(5,11), MD(5,21), },
    std::array{ MD(4,15), MD(5,31), MD(6,10), },
    std::array{ MD(4,7), MD(5,23), MD(6,2), },
    std::array{ MD(3,22), MD(5,7), MD(5,17), },
    std::array{ MD(4,11), MD(5,27), MD(6,6), },
    std::array{ MD(4,3), MD(5,19), MD(5,29), },
    std::array{ MD(3,19), MD(5,4), MD(5,14), },
    std::array{ MD(4,7), MD(5,23), MD(6,2), },
    std::array{ MD(3,30), MD(5,15), MD(5,25), },
    std::array{ MD(3,15), MD(4,30), MD(5,10), },
    std::array{ MD(4,4), MD(5,20), MD(5,30), },
    std::array{ MD(3,26), MD(5,11), MD(5,21), },
    std::array{ MD(4,15), MD(5,31), MD(6,10), },
    std::array{ MD(3,31), MD(5,16), MD(5,26), },
    std::array{ MD(3,23), MD(5,8), MD(5,18), },
    std::array{ MD(4,11), MD(5,27), MD(6,6), },
    std::array{ MD(3,27), MD(5,12), MD(5,22), },
    std::array{ MD(3,19), MD(5,4), MD(5,14), },
    ...
    std::array{ MD(4,5), MD(5,21), MD(5,31), },
    std::array{ MD(3,28), MD(5,13), MD(5,23), },
    std::array{ MD(4,17), MD(6,2), MD(6,12), },
    std::array{ MD(4,1), MD(5,17), MD(5,27), },
    std::array{ MD(3,24), MD(5,9), MD(5,19), },
    std::array{ MD(4,13), MD(5,29), MD(6,8), },
    std::array{ MD(3,29), MD(5,14), MD(5,24), },
...
TEST_CASE("проверка расчета даты Двунадесятые непереходящие праздники"){
  ...
  constexpr std::array<const std::array<MD,9>&, GREAT_INDICTION_LENGTH> arr = {
    a1,
    a1,
    a1,
    a1,
